...
def mock_excel_terms():
    ...
    return [
        MiscIncome(amount=100.0, memo="Term 30", chart_of_account1="30", chart_of_account2="Net 30", source="excel"),
        MiscIncome(amount=200.0, memo="Term 45", chart_of_account1="45", chart_of_account2="Net 45", source="excel")
    ]
